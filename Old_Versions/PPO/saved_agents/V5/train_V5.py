"""
V5 Training Script -- run from THIS folder.
...
V5 change from V4: pressure reward (better gradient in sparse/low traffic).
"""
import os
...
from sumo_rl_env_V5 import create_sumo_env, SwitchOrKeepWrapper, MultiRouteWrapper
...
def main():
    ...
    if resume_path:
        ...
        print(f"Fresh V5 agent: {agent_id}")
    ...
    if resume_path and os.path.exists(resume_path):
        ...
        # V5 fresh hyperparameters (same as V4 initial)
        model = MaskablePPO(
            "MlpPolicy", vec_env,
