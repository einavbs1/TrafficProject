...
# â”€â”€ Paths relative to this script â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
_HERE       = os.path.dirname(os.path.abspath(__file__))
MODELS_DIR  = os.path.join(_HERE, "models")
RESULTS_DIR = os.path.join(_HERE, "results")

# â”€â”€ Import shared evaluation logic from src/ â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def main():
    ...
    with open(os.path.join(eval_dir, "evaluation_config.txt"), "w") as f:
        f.write(f"Run: {timestamp}\nSeeds: {seeds}\nAgent: V5 (pressure reward)\n")

    print(f"V5 EVALUATION  |  results â†’ {eval_dir}\n", flush=True)

    # Auto-find latest V5 model (exclude backups)
