"""
V7 Training Script -- run from THIS folder.

    cd PPOagent/saved_agents/V7
    python train_V7.py --timesteps 6000000

V7 changes over V6-camera:
    - CAMERA_RANGE 150m (was 100m)
    - STARVATION_THRESHOLD 45s (was 90s)
    - Idle switch penalty 0.03 when intersection empty
...
def main():
    ...
    if resume_path:
        ...
        print(f"Fresh V7 agent: {agent_id}")
    ...
    print(f"Training V7 for {args.timesteps} steps")
